    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.FileField(blank=True, upload_to='contracts_files/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('phone', models.CharField(max_length=15)),
                ('prospects', models.ManyToManyField(blank=True, to='api.Prospect')),
            ],
        ),
        migrations.AddField(
            model_name='contract',
            name='sales_employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.salesemployee'),
        ),
        migrations.AddField(
            model_name='client',
            name='sales_contact',
